...
public class TestParking {
    ...
    public static void main(String[] args) {
        LocalDateTime exitTime1 = LocalDateTime.of(2020, Month.DECEMBER, 17, 23, 50);
        LocalDateTime exitTime2 = LocalDateTime.of(2020, Month.DECEMBER, 02, 18, 40);
        LocalDateTime exitTime3 = LocalDateTime.of(2020, Month.DECEMBER, 17, 05, 30);
